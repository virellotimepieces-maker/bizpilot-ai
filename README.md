...
**Operator (you):** [docs/operator-setup.md](docs/operator-setup.md) — Stripe first, then OpenAI, then optional Gmail. Paste values into Vercel Production. Never commit them.
...
| `APP_URL` | Public origin for Stripe redirects and the widget snippet. Production: `https://www.mybizpilotai.com` |
...
| `OPENAI_API_KEY` | Paid widget AI replies and Gmail suggested replies |
